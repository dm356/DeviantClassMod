...
static function X2AbilityTemplate GremlinAbility(name DataName, string IconImage, X2Effect Effect, optional bool bCrossClassEligible = false, optional int ShotHUDPriority = default.AUTO_PRIORITY, optional EActionPointCost Cost = eCost_SingleConsumeAll, optional int Hostility = eHostility_Offensive)
{
