...
class PsionDevUIScreenListener extends UIScreenListener config(PsionDevAbilities); //GTS Class
...
event OnInit(UIScreen Screen)
{
    if(IsStrategyState())
    {
        ...
        {
            AddPsionPerkGTSTemplate(); //GTS SKILL
            didUpdateTemplates = true;
        }   
    }
}

function AddPsionPerkGTSTemplate() //GTS SKILL
{
  ...
  Template.SoldierUnlockTemplates.AddItem('PsionPerkGTS'); //GTS SKILL
