...
static function UpdateTemplates()
{
  ...
  `Log("Template Mods: Starting Template Modifications");
  ...
  for (idx = 0; idx < TemplateMods.Length; ++idx)
  {
    ...
    {
      `Log("Template Mods: Updating Character Templates for " $ ModTemplate.DataName);
